...
namespace Infrastructure.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<Order> CreateOrderAsync(string buyerEmail, int deliveryMethodId, string basketId, AddressForOrder shippingAddress)
        {
        ...
        public async Task<IReadOnlyList<Order>> GetOrdersForUserAsync(string buyerEmail)
        {
            ...
            return await _unitOfWork.Repository<Order>().GetAsync(specification);
        }
    }
}
